...
\includegraphics{1.jpg}
		...
		\item Logic gates perform logical operations that take binary input (0s and 1s) and produce  a single binary output. They are used in most electronic device including: \\
			\begin{figure}[h!]
				...
				\includegraphics[width=\linewidth]{phone.jpg}
				\caption{Smartphones}
				\end{subfigure}
			\begin{subfigure}[b]{0.35\linewidth}
				\includegraphics[width=\linewidth]{tablet.jpg}
				\caption{Tablets}
			\end{subfigure}
		\begin{subfigure}[b]{0.35\linewidth}
			\includegraphics[width=\linewidth]{sdcard.jpg}
